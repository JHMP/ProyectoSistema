...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2015 a las 18:57:40
...
`id` int(11) NOT NULL,
  ...
  `id_depa` varchar(50) NOT NULL,
  `id_muni` varchar(50) NOT NULL,
  `tipo_candidato` varchar(15) NOT NULL,
  `id_inscrip_parti` varchar(20) NOT NULL,
  `id_depas` varchar(50) NOT NULL,
  `id_munis` varchar(50) NOT NULL,
  `id_cargo` varchar(25) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `inscrip_candi`
--

INSERT INTO `inscrip_candi` (`id`, `dui`, `apellido`, `nombre`, `id_depa`, `id_muni`, `tipo_candidato`, `id_inscrip_parti`, `id_depas`, `id_munis`, `id_cargo`) VALUES
(9, '12345612-9', 'Garcia Torres', 'Daniel Eduardo', '08', 'Zacatecoluca', 'Partido', 'CCC', '08', 'Zacatecoluca', 'Presidencial');
...
(31, 'BBB', 'imagenes/BBB.png', '11112222-1', 'Melvin Palacios'),
(32, 'AAA', 'imagenes/AAA.png', '12121212-1', 'Alberto Salmeron'),
(33, 'RS', 'imagenes/RS.jpg', '12345678-9', 'Jorge Arias'),
(34, 'TS', 'imagenes/TS.jpg', '87654321-9', 'Melvin Salmeron');
...
`id` int(11) NOT NULL,
  ...
  `iddepa` varchar(100) NOT NULL,
  `idmuni` varchar(100) NOT NULL,
...
(4, '12312312-3', 'Melvin', 'Ayala', 'Candidato 4.png', 'Hombre', '2015-06-28', 'Zacate', '08', 'Zacatecoluca', 0),
(5, '11111111-1', 'Jorge Alberto', 'Ayala Hernandez', 'Candidato 5.jpg', 'Hombre', '2015-06-30', 'Rio Blanco', '08', 'Zacatecoluca', 1),
(6, '11112222-0', 'Angel Roberto', 'Hernandez', 'DDD.png', 'Hombre', '2015-06-30', 'San Carlos', '08', 'Zacatecoluca', 0);
...
(1, 'TS', 'Presidentes', 8, 0, 4),
(2, 'TS', 'Alcaldes', 8, 0, 4),
(3, 'TS', 'Diputados', 8, 0, 4),
(4, 'AAA', 'Presidentes', 8, 0, 3),
(5, 'AAA', 'Alcaldes', 8, 0, 3),
(6, 'AAA', 'Diputados', 8, 0, 3),
(7, 'BBB', 'Presidentes', 8, 0, 2),
(8, 'BBB', 'Alcaldes', 8, 0, 2),
(9, 'BBB', 'Diputados', 8, 0, 2),
(10, 'BBB', 'Presidentes', 8, 0, 1),
(11, 'AAA', 'Alcaldes', 8, 0, 1),
(12, 'RS', 'Diputados', 8, 0, 1);
